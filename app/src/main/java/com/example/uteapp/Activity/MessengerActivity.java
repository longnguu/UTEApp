...
import com.example.uteapp.Adapter.MessengerAdapter;
        ...
        databaseReference.child("chat").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if (dataSnapshot.child("user_1").getValue(String.class).equals(Data.dataPhone) || dataSnapshot.child("user_2").getValue(String.class).equals(Data.dataPhone)){
                        i++;
                        System.out.println(i+"aad");
                    }
                    }
                }
            }
                                        ...
                                        if (dataSnapshot1.hasChild("user_1") && dataSnapshot1.hasChild("user_2") && dataSnapshot1.hasChild("messenger")) {
                                            ...
                                            if ((getUserOne.equals(mobile) && getUserTwo.equals(getMobile)) || (getUserOne.equals(getMobile) && getUserTwo.equals(mobile))) {
                                                for (DataSnapshot chatDataSnapShot : dataSnapshot1.child("messenger").getChildren()) {
                                                    ...
                                                    if (chatDataSnapShot.child("mobile").getValue(String.class).equals(Data.dataPhone)){
                                                ...
                                                HomeActivity.updateUnSeen(messengerLists);
    ...
    public void GetIntent(){
        databaseReference.child("users").child(Data.dataPhone).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                intentMain = new Intent(MessengerActivity.this, HomeActivity.class);
