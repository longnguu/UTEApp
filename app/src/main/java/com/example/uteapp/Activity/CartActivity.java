...
import com.example.uteapp.Adapter.CartAdapter;
...
//
        ...
        databaseReference.child("GioHang").child(mobile).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                cartLists.clear();
                int i=0;
    ...
    public void GetIntent(){
        databaseReference.child("users").child(mobile).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                intentMain = new Intent(CartActivity.this, HomeActivity.class);
