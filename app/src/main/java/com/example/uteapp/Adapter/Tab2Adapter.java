...
public class Tab2Adapter extends RecyclerView.Adapter<Tab2Adapter.Tab2AdapterViewHolder>{
    private List<PicVideos> mData;
    private Context context;

    public  Tab2Adapter(List<PicVideos> mData, Context context) {
        this.mData = mData;
    ...
    @NonNull
    @Override
    public Tab2Adapter.Tab2AdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView;
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_fr_home_lv, parent, false);
        return new Tab2Adapter.Tab2AdapterViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull Tab2Adapter.Tab2AdapterViewHolder holder, int position) {
...
//                setVideo(dataVideo,holder.v4);
    ...
    public class Tab2AdapterViewHolder extends RecyclerView.ViewHolder{
        RelativeLayout c1,c2,c3,c4;
        ImageView a1,a2,a3,a4;
        VideoView v1,v2,v3,v4;
        LinearLayout linearLayout,toreels;
        TextView tabTitle;
        public Tab2AdapterViewHolder(@NonNull View itemView) {
            super(itemView);
